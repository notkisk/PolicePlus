...
val MIGRATION_3_4 = object : Migration(3, 4) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE car_table ADD COLUMN ticket_type TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE car_table ADD COLUMN ticket_details TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE car_table ADD COLUMN issue_date TEXT DEFAULT ''")
    }
}