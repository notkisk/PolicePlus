    ...
    AlertDialog(
        ...
        text = {
            Column(
                ...
                Text(name, color = Color(0xFFE7E7E7), fontWeight = FontWeight.Medium, fontSize = 16.sp)
                Text("655859579058", color = Color.White, fontSize = 16.sp)
                ...
                details.forEach { (label, value) ->
                    Row(modifier = Modifier.fillMaxWidth()) {
                        ...
                        Text(value, color = Color(0xFFE7E7E7), fontSize = 16.sp, textAlign = TextAlign.End)
                    }
                }
            }
        },
